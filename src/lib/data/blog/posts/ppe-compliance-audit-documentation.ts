...
export const ppeComplianceAuditDocumentation: BlogPost = {
  ...
  "leadAr": "نادراً ما تُخفق تدقيقات الملابس الواقية بسبب الملابس نفسها، بل بسبب الملف الذي خلفها: شهادة لم تُحفظ، ورمز دفعة لم يُسجَّل، وسجل صرف فيه فراغ مكان التوقيع. هذا ما يطلبه المدقّق فعلاً، وكيف تبنيه قبل أن تحتاج إليه.",
  "sections": [
    {
    ...
    },
    {
      ...
      "body": "A certificate describes a sample tested on a date, not the roll delivered to you two years later — and the batch record is what connects the two. Traceability is the quiet backbone of the whole file, and it is the part most often missing where protective clothing is bought as a commodity. The principle is simple: every [protective garment](/industries/manufacturing/) should carry a permanent marking that leads backwards to the fabric lot it was cut from and forwards to the person it was issued to. In practice that means a lot code applied at manufacture, legible after industrial laundering, and recorded on the goods received note rather than left on the carton. Your supplier holds the upstream half — which roll, which dye lot, which finishing run — and you hold the downstream half. Traceability also makes a problem survivable: if a seam fails or a reflective band delaminates, a lot code lets you quarantine one production run instead of a whole fleet, and tell the auditor exactly which garments were affected.",
      "bodyAr": "الشهادة تصف عينة اختُبرت في تاريخ معيّن، لا اللفّة التي سُلّمت إليك بعد عامين؛ وسجل الدفعات هو ما يربط بينهما. والتتبّع هو العمود الفقري الصامت للملف كله، وأكثر أجزائه غياباً حين تُشترى [الملابس الواقية](/ar/industries/manufacturing/) كسلعة عامة. والمبدأ بسيط: يجب أن تحمل كل قطعة واقية علامة دائمة تتيح تتبّعها رجوعاً إلى دفعة القماش التي قُصّت منها، وتقدّماً إلى الشخص الذي صُرفت له. عملياً يعني ذلك رمز دفعة يُطبع عند التصنيع، ويبقى مقروءاً بعد الغسيل الصناعي، ويُسجَّل في سند الاستلام لا أن يُترك على الكرتون وحده. المورّد يملك النصف الأعلى من السلسلة — أي لفّة، وأي حمّام صباغة، وأي دورة تجهيز — وأنت تملك النصف الأدنى. والتتبّع أيضاً هو ما يجعل المشكلة قابلة للاحتواء: إذا فشلت حياكة أو انفصل شريط عاكس، يتيح لك رمز الدفعة عزل دفعة إنتاج واحدة بدل سحب المخزون كله، وأن تخبر المدقّق بدقة أي القطع تأثرت وأيها لم تتأثر."
    },
    {
