...
export const howManyScrubSetsPerNurse: BlogPost = {
  ...
  "leadAr": "يسأل كل مستشفى في النهاية عن عدد أطقم السكرابز التي يجب صرفها لكل ممرض، ولا يستطيع أي مورّد أن يجيب بصدق دون معرفة تفاصيل المنشأة. العدد يُحسب ولا يُقتبس. يعرض هذا الدليل المتغيرات التي تحدده: مدة دورة الغسيل، وكثافة جدول المناوبات، والتبديل أثناء الوردية، والمخزون الاحتياطي، والاختيار بين الملكية الفردية والتبادل المركزي.",
  "sections": [
    {
    ...
    },
    {
      ...
      "bodyAr": "المتغير الأخير هو النموذج نفسه. في نموذج الصرف الفردي تحتفظ كل ممرضة بتخصيص شخصي بمقاساتها وتتحمل مسؤولية إعادته؛ فيرتفع العدد لكل فرد، ويتحسن المقاس، ويعتني الكادر بالقطع أكثر، لكن إجمالي المخزون يتضخم ويصبح تصحيح أخطاء المقاسات مكلفاً. وفي نموذج التبادل المركزي تُجمَّع القطع وتُصرف من كاونتر أو جهاز صرف مقابل إعادة المتسخ؛ فيصغر حجم الأسطول لأن المخزون الساكن مشترك بدل أن يقبع في الخزائن، وتشتد السيطرة على ما يخرج من المبنى، لكن هذا النموذج لا ينجح إلا إذا كان توزيع المقاسات صحيحاً وكانت الإعادة مُلزمة. وكثيراً ما يكون النموذج الهجين هو الحل العملي: تجميع أزياء العمليات والأقسام عالية الخطورة مع صرف سكرابز الأقسام العادية بشكل فردي. وأياً كان النموذج، ينبغي الاتفاق على الكميات مع المورّد قبل أول طلبية كبيرة، لأن النموذج يحدد منحنى المقاسات والترميز اللوني وإيقاع إعادة الطلب. تصنّع يونيوم داخل المملكة منذ 2013 وفق ISO 9001:2015 وبأقمشة حاصلة على OEKO-TEX Standard 100."
    }
  ],
  "faqs": [
    {
