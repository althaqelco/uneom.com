...
export const retailUniformRollout40Stores: BlogPost = {
  ...
  "sections": [
    {
      ...
      "bodyAr": "يبدو تغيير الزي في أربعين متجراً قراراً شرائياً، لكنه يسلك في الواقع سلوك مشروع توزيع. الأقمشة والقصّات هي الجزء الأسهل؛ أما الجزء الأصعب فهو أن الفروع الأربعين موزّعة على مدن مختلفة، بأعداد موظفين متباينة، وساعات عمل غير متطابقة، ومعدلات دوران وظيفي تستمر في التغيّر أثناء تنفيذ البرنامج نفسه. تعامل مع الإطلاق بوصفه جدولاً زمنياً له ملّاك معرّفون بالاسم، لا أمر شراء واحداً، وستختفي معظم الإخفاقات المألوفة. ابدأ بسجل للفروع قبل أي شيء آخر: الموقع، وساعات الاستلام، ومساحة التخزين خلف صالة البيع، والمسؤول الذي يوقّع على استلام الكراتين، وجهة الاتصال التي ستتابع المقاسات الناقصة. ثم حدّد من يملك تاريخ الإطلاق، ومن يملك دقة المقاسات، ومن يملك التخلص من الزي القديم، فهذه المسؤوليات الثلاث تُفترض عادةً ولا تُسنَد صراحةً. كما تمنحك خطة البرنامج إجابة مسنودة حين يسأل مدير المنطقة عن سبب وجود فرعه في الموجة الثالثة. فالترتيب قرار تتخذه عن قصد، لا نتيجة لمن ردّ على البريد أولاً."
    },
    {
      "heading": "Sizing, Branch by Branch",
      "headingAr": "المقاسات فرعاً بفرع",
      "body": "Sizing is where multi-site rollouts quietly fail, because a size list collected centrally from an HR system reflects who was employed on the day the file was exported, not who will be standing on the floor at launch. Run a fitting exercise at branch level with a physical size set, and let people try garments on rather than self-declare. Self-declared sizes tend to cluster around what staff believe they wear, and the corrections arrive later as exchanges that land on your team during launch week. Capture the data in one structured template per branch, with employee name, role, garment type, size, and any accommodation such as longer sleeves, a longer tunic length, or a modest-cut option, so the record travels with the order instead of living in a manager's phone. Add a buffer of spare sizes per branch for new hires and mid-programme transfers, sized against the branch's own turnover pattern rather than a flat rule. Lock the sizing file with a stated cut-off date, and treat later changes as a separate replenishment.",
      "bodyAr": "المقاسات هي المكان الذي تتعثر فيه عمليات الإطلاق متعددة الفروع بهدوء، لأن قائمة مقاسات مستخرجة مركزياً من نظام الموارد البشرية تعكس من كان على رأس العمل يوم تصدير الملف، لا من سيقف على أرض المتجر يوم الإطلاق. نفّذ جلسة قياس على مستوى الفرع بمجموعة عيّنات فعلية، ودع الموظفين يجرّبون القطع بدل التصريح الذاتي بالمقاس. فالمقاسات المصرّح بها ذاتياً تميل إلى التجمّع حول ما يعتقد الموظف أنه يرتديه، وتصل التصحيحات لاحقاً على شكل استبدالات تقع على فريقك في أسبوع الإطلاق. سجّل البيانات في نموذج منظّم واحد لكل فرع يتضمن الاسم والدور ونوع القطعة والمقاس وأي تكييف مطلوب مثل أكمام أطول، أو طول تونيك أكبر، أو قصّة محتشمة، ليسافر السجل مع الطلب بدل أن يبقى في هاتف مدير الفرع. أضف مخزوناً احتياطياً من المقاسات لكل فرع للتعيينات الجديدة والنقل أثناء البرنامج، مقدَّراً وفق نمط دوران الفرع نفسه لا بقاعدة موحّدة. ثم أغلق ملف المقاسات بتاريخ حدٍّ معلن، وعامل أي تغيير لاحق بوصفه تزويداً منفصلاً."
    },
    {
  ...
  "faqs": [
    ...
    },
    {
      ...
      "aAr": "نفّذ جلسات قياس على مستوى الفرع بمجموعة عيّنات فعلية بدل الاعتماد على التصريح الذاتي بالمقاس، وسجّل النتائج في نموذج منظّم واحد لكل فرع يغطي الدور والقطعة والمقاس وأي تكييف مطلوب. ثبّت تاريخ حدٍّ واضحاً، وأضف مخزوناً احتياطياً للتعيينات الجديدة، وعامل أي تغيير بعد ذلك التاريخ بوصفه تزويداً لا جزءاً من طلب الإطلاق."
    },
    {
