...
export const metadata: Metadata = {
  ...
  description: 'Expert guide to uniform procurement for Saudi organizations. Learn best practices for budgeting, ordering, supplier selection, quality assurance, and uniform program management.',
  keywords: 'uniform procurement guide, corporate workwear purchasing, Saudi Arabia uniform sourcing, uniform supplier selection, workwear budgeting, uniform quality assurance, bulk ordering best practices',
  openGraph: {
    title: 'Uniform Procurement Guide | Purchasing Best Practices | UNEOM Saudi Arabia',
    description: 'Expert guide to uniform procurement for Saudi organizations. Learn best practices for budgeting, ordering, supplier selection, quality assurance, and uniform program management.',
    type: 'website',
