...
export const metadata: Metadata = {
  title: 'Lightweight Tactical Guide | Professional Resources - UNEOM Uniforms',
  description: 'Discover premium Lightweight Tactical Guide by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Lightweight Tactical Guide
            </h1>
            
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Lightweight Tactical Guide by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
