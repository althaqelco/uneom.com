...
export const metadata: Metadata = {
  title: 'Healthcare Uniform Standards | Professional Resources - UNEOM Uniforms',
  description: 'Discover premium Healthcare Uniform Standards by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Healthcare Uniform Standards
            </h1>
            
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Healthcare Uniform Standards by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
