...
export const metadata: Metadata = {
  title: 'Nursing Uniform Guide | Professional Resources - UNEOM Uniforms',
  description: 'Discover premium Nursing Uniform Guide by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Nursing Uniform Guide
            </h1>
            
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Nursing Uniform Guide by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
