...
export const metadata: Metadata = {
  title: 'Uniform Program Management | Professional Services - UNEOM Uniforms',
  description: 'Discover premium Uniform Program Management by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Uniform Program Management by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
