...
export const metadata: Metadata = {
  title: 'Tactical Equipment Program | Professional Services - UNEOM Uniforms',
  description: 'Discover premium Tactical Equipment Program by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Tactical Equipment Program by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
