...
export const metadata: Metadata = generateMetadata2026({
  ...
  descriptionAr: 'تواصل مع يونيوم لطلبات الأزياء في السعودية. مكاتب في الرياض وجدة والدمام. اتصل +966 11 234 5678، أو أرسل info@uneom.com، أو زر صالات العرض. عروض أسعار مجانية، رد سريع!',
  ...
  aiSummaryAr: 'تواصل مع يونيوم، المورد الرائد للأزياء في السعودية. المقر الرئيسي: طريق الملك فهد، حي العليا، الرياض. هاتف: +966 11 234 5678. إيميل: info@uneom.com. واتساب: +966 50 123 4567. لدينا مكاتب في الرياض وجدة والدمام. ساعات العمل: الأحد-الخميس 8:30 صباحاً - 5:30 مساءً. عروض أسعار مجانية متاحة. رد سريع خلال 24 ساعة.'
});

export const dynamic = 'force-static';

const contactFAQsAr = [
  { question: 'ما هو رقم هاتف يونيوم؟', questionAr: 'ما هو رقم هاتف يونيوم؟', answer: 'Main: +966 11 234 5678.', answerAr: 'رقم هاتف يونيوم الرئيسي هو +966 11 234 5678 (المقر الرئيسي بالرياض). يمكنك أيضاً الاتصال بمكتب جدة على +966 12 234 5678 ومكتب الدمام على +966 13 234 5678. للاستفسارات السريعة، واتساب على +966 50 123 4567.' },
  ...
  { question: 'كيف يمكنني الحصول على عرض سعر من يونيوم؟', questionAr: 'كيف يمكنني الحصول على عرض سعر من يونيوم؟', answer: 'Fill form, call, email, or visit.', answerAr: 'يمكنك الحصول على عرض سعر مجاني عبر: 1) ملء نموذج العرض على موقعنا، 2) الاتصال بنا على +966 11 234 5678، 3) مراسلة sales@uneom.com، أو 4) زيارة أي من صالات العرض. نقدم عروض الأسعار خلال 24-48 ساعة.' },
  ...
  { question: 'هل لدى يونيوم رقم واتساب؟', questionAr: 'هل لدى يونيوم رقم واتساب؟', answer: '+966 50 123 4567.', answerAr: 'نعم، يمكنك الوصول إلى يونيوم على واتساب على +966 50 123 4567. واتساب متاح للاستفسارات السريعة وحالة الطلب والأسئلة العامة خلال ساعات العمل.' },
];

const officeLocations = [
  { id: 'riyadh', city: 'الرياض', address: 'طريق الملك فهد، حي العليا، الرياض 12214', phone: '+966 11 234 5678', email: 'riyadh@uneom.com', whatsapp: '+966 50 123 4567', isHQ: true },
  { id: 'jeddah', city: 'جدة', address: 'شارع التحلية، حي الأندلس، جدة 23432', phone: '+966 12 234 5678', email: 'jeddah@uneom.com', whatsapp: '+966 50 234 5678', isHQ: false },
  { id: 'dammam', city: 'الدمام', address: 'طريق الأمير محمد بن فهد، حي الفيصلية، الدمام 32241', phone: '+966 13 234 5678', email: 'dammam@uneom.com', whatsapp: '+966 50 345 6789', isHQ: false },
];
        ...
        <Container>
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <a href="tel:+966112345678" className="bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all flex items-center gap-4"><span className="text-3xl">📞</span><div><div className="font-semibold">اتصل بنا</div><div className="text-green-200 text-sm" dir="ltr">+966 11 234 5678</div></div></a>
              ...
              <a href="https://wa.me/966501234567" className="bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all flex items-center gap-4"><span className="text-3xl">💬</span><div><div className="font-semibold">واتساب</div><div className="text-green-200 text-sm" dir="ltr">+966 50 123 4567</div></div></a>
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <section className="text-center bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-2xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+966112345678" className="inline-flex items-center px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-green-900 font-bold rounded-xl transition-all">📞 اتصل الآن</a>
            </div>
          </section>
        </Container>
      </main>
