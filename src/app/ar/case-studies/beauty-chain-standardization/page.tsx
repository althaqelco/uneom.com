...
export const metadata: Metadata = generateMetadata2026({
  title: 'دراسة حالة: توحيد هوية صالونات التجميل في السعودية | يونيوم',
  titleAr: 'دراسة حالة: توحيد هوية صالونات التجميل | متجر يونيوم',
  description: 'كيف ساعدت يونيوم سلسلة صالونات تجميل كبرى في السعودية على توحيد هويتها البصرية وتقليل تكاليف الأزياء بنسبة 30٪.',
  descriptionAr: 'كيف ساعدت يونيوم سلسلة صالونات تجميل كبرى في السعودية على توحيد هويتها البصرية وتقليل تكاليف الأزياء بنسبة 30٪.',
  keywords: ['أزياء صالونات التجميل', 'توحيد الهوية البصرية', 'ملابس سبا'],
  keywordsAr: ['أزياء صالونات التجميل', 'توحيد الهوية البصرية', 'ملابس سبا'],
  locale: 'ar',
  pageType: 'article',
  path: '/ar/case-studies/beauty-chain-standardization',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'دراسة حالة: توحيد هوية صالونات التجميل',
  aiSummary: 'كيف ساعدت يونيوم سلسلة صالونات تجميل كبرى في السعودية على توحيد هويتها البصرية وتقليل تكاليف الأزياء بنسبة 30٪.',
});
...
export default function BeautyChainCaseStudyPageAR() {
  return (
    <>
      <SEO2026 title="دراسة حالة: توحيد هوية صالونات التجميل" titleAr="دراسة حالة: توحيد هوية صالونات التجميل" description="كيف ساعدت يونيوم سلسلة صالونات تجميل كبرى في السعودية على توحيد هويتها البصرية وتقليل تكاليف الأزياء بنسبة 30٪." locale="ar" pageType="article" mainEntity="دراسة حالة: توحيد هوية صالونات التجميل" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="دراسة حالة: توحيد هوية صالونات التجميل" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'دراسة حالة: توحيد هوية صالونات التجميل', url: '/ar/case-studies/beauty-chain-standardization' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'دراسة حالة: توحيد هوية صالونات التجميل', href: '/ar/case-studies/beauty-chain-standardization' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">دراسة حالة: توحيد هوية صالونات التجميل</h1>
            <p className="text-xl text-gray-300 leading-relaxed">كيف ساعدت يونيوم سلسلة صالونات تجميل كبرى في السعودية على توحيد هويتها البصرية وتقليل تكاليف الأزياء بنسبة 30٪.</p>
          </div>
        </Container>
      </section>
