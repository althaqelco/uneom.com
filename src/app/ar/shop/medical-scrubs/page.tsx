...
const products = [
  ...
  { id: 'doctor-coat', name: 'معطف طبيب أبيض', description: 'معاطف بيضاء كلاسيكية للأطباء', price: 'من 179 ريال', image: '/images/products/doctor-coat.jpg', href: '/ar/shop/medical-scrubs/doctor-coat', features: ['قماش فاخر', 'خالي من التجاعيد', 'جاهز للتطريز'] },
