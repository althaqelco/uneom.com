...
export const metadata: Metadata = generateMetadata2026({
  title: 'إكسسوارات طبية في السعودية | يونيوم',
  titleAr: 'إكسسوارات طبية | متجر يونيوم',
  description: 'إكسسوارات طبية متخصصة تشمل غطاء الرأس الطبي، جوارب ضاغطة، وأحذية طبية مريحة لعمل المناوبات.',
  descriptionAr: 'إكسسوارات طبية متخصصة تشمل غطاء الرأس الطبي، جوارب ضاغطة، وأحذية طبية مريحة لعمل المناوبات.',
  keywords: ['إكسسوارات طبية', 'غطاء رأس جراحي', 'حذاء طبي'],
  keywordsAr: ['إكسسوارات طبية', 'غطاء رأس جراحي', 'حذاء طبي'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/medical-accessories',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'إكسسوارات طبية',
  aiSummary: 'إكسسوارات طبية متخصصة تشمل غطاء الرأس الطبي، جوارب ضاغطة، وأحذية طبية مريحة لعمل المناوبات.',
});
...
export default function MedicalAccessoriesShopPageAR() {
  return (
    <>
      <SEO2026 title="إكسسوارات طبية" titleAr="إكسسوارات طبية" description="إكسسوارات طبية متخصصة تشمل غطاء الرأس الطبي، جوارب ضاغطة، وأحذية طبية مريحة لعمل المناوبات." locale="ar" pageType="product" mainEntity="إكسسوارات طبية" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="إكسسوارات طبية" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'إكسسوارات طبية', url: '/ar/shop/medical-accessories' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'إكسسوارات طبية', href: '/ar/shop/medical-accessories' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">إكسسوارات طبية</h1>
            <p className="text-xl text-gray-300 leading-relaxed">إكسسوارات طبية متخصصة تشمل غطاء الرأس الطبي، جوارب ضاغطة، وأحذية طبية مريحة لعمل المناوبات.</p>
          </div>
        </Container>
      </section>
