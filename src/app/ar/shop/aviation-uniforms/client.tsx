...
export default function AviationUniformsClientPage() {
  const locale = 'ar';
  ...
  return (
    <div className="bg-gray-50 min-h-screen" dir="rtl">
        ...
        <Container>
          <div className="py-16">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">أزياء وملابس الطيران للخطوط الجوية السعودية | زي طيارين ومضيفين وطاقم أرضي | يونيوم المملكة العربية السعودية</h1>
              <p className="mt-4 text-lg text-gray-600">
                أزياء طيران احترافية وأنيقة مصممة لمختلف الوظائف في قطاع الطيران في المملكة العربية السعودية.
                تقدم مجموعتنا للطيران جودة ممتازة ومظهر احترافي وراحة عملية للطيارين، المضيفين، وطاقم الأرض.
              </p>
            </div>
      ...
      <section className="py-16">
        <Container>
          <SectionHeading centered>لماذا تختار أزياء الطيران من يونيوم؟</SectionHeading>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                أقمشة متينة عالية الجودة مصممة لتتحمل متطلبات صناعة الطيران، مع الحفاظ على المظهر الاحترافي على المدى الطويل.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                خيارات تخصيص للعلامة التجارية لشركة الطيران الخاصة بك، بما في ذلك الشعارات والألوان المؤسسية والتطريز.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                أزياء مصممة مع مراعاة الراحة خلال الرحلات الطويلة، مع أقمشة تسمح بالتنفس وقصات مريحة.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                نقدم حلول أزياء شاملة لشركات الطيران، تغطي جميع الأقسام من طاقم الطائرة إلى طاقم الأرض والصيانة.
              </p>
            </div>
          </div>
        </Container>
