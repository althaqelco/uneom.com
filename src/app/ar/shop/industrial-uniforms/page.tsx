      ...
      <section className="relative bg-gray-900 text-white">
        ...
        <Container className="relative z-10 py-20 md:py-28">
          <div className="max-w-3xl text-right">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">ملابس العمل الصناعية عالية الجودة</h1>
      ...
      <section className="py-12 md:py-20 bg-primary-600 text-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">هل تحتاج إلى ملابس صناعية لفريق عملك؟</h2>
            <p className="text-xl mb-8">
              نقدم حلولًا متكاملة للزي الموحد الصناعي تناسب احتياجات شركتك، بدءًا من التصميم وحتى التوريد والتخصيص. تواصل معنا اليوم للحصول على عرض سعر مخصص.
            </p>
