...
export const metadata: Metadata = {
  title: 'قفازات مقاومة للحرارة للاستخدام الصناعي | حماية معتمدة لليدين | يونيوم',
  description: 'توفر قفازات يونيوم المقاومة للحرارة حماية متفوقة في البيئات الصناعية السعودية مع مقاومة حرارية من الدرجة 3، وحماية من الثقب، وتصميم مريح. معتمدة وفقًا لمعايير EN 407 وSASO لأقصى درجات السلامة في مكان العمل.',
  keywords: 'قفازات مقاومة للحرارة السعودية, حماية اليدين الصناعية, قفازات سلامة مضادة للحرارة, قفازات معتمدة EN 407, قفازات عمل مقاومة للثقب, معدات الحماية الحرارية, معدات الحماية الشخصية الصناعية السعودية, قفازات سلامة قابلة للتخصيص',
  openGraph: {
    title: 'قفازات صناعية مقاومة للحرارة | حماية حرارية متقدمة لأماكن العمل السعودية',
    description: 'مصممة خصيصًا للبيئات الصناعية المتطلبة في المملكة العربية السعودية. مقاومة حرارية من الدرجة 3 تصل إلى 350 درجة مئوية، راحة اليد معززة للحماية من الثقب، وتصميم مريح للاستخدام المطول. تتجاوز معايير السلامة الخليجية والدولية.',
    images: [
      {
...
export default function HeatResistantGlovesPageArabic() {
  ...
  const productData = {
    ...
    description: 'قفازات مقاومة للحرارة مصممة خصيصًا للاستخدام في البيئات الصناعية السعودية المتطلبة. توفر هذه القفازات حماية متميزة من الحرارة العالية تصل إلى 350 درجة مئوية، مع تعزيز منطقة راحة اليد للحماية من الثقب ومقاومة الاحتكاك. تم تصميمها بعناية لتوفير الراحة والمرونة مع الحفاظ على أقصى درجات الحماية للعاملين في القطاعات الصناعية.',
    features: [
      'مقاومة حرارية من الدرجة 3 تصل إلى 350 درجة مئوية',
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "قفازات متقدمة مقاومة للحرارة مصممة للبيئات الصناعية السعودية، تتميز بمقاومة حرارية من الدرجة 3 تصل إلى 350 درجة مئوية وراحة يد معززة للحماية من الثقب.",
