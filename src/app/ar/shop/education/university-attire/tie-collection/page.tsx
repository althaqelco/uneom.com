...
export const metadata: Metadata = generateMetadata2026({
  title: 'ربطات العنق الجامعية في السعودية | يونيوم',
  titleAr: 'ربطات العنق الجامعية | متجر يونيوم',
  description: 'تشكيلة ربطات العنق الجامعية المخصصة. خيارات مطرزة أو مطبوعة بشعار الجامعة للكليات وجمعيات الخريجين.',
  descriptionAr: 'تشكيلة ربطات العنق الجامعية المخصصة. خيارات مطرزة أو مطبوعة بشعار الجامعة للكليات وجمعيات الخريجين.',
  keywords: ['ربطات عنق جامعية', 'ربطات تخرج', 'شعار كلية'],
  keywordsAr: ['ربطات عنق جامعية', 'ربطات تخرج', 'شعار كلية'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/education/university-attire/tie-collection',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'ربطات العنق الجامعية',
  aiSummary: 'تشكيلة ربطات العنق الجامعية المخصصة. خيارات مطرزة أو مطبوعة بشعار الجامعة للكليات وجمعيات الخريجين.',
});
...
export default function UniversityTiesShopPageAR() {
  return (
    <>
      <SEO2026 title="ربطات العنق الجامعية" titleAr="ربطات العنق الجامعية" description="تشكيلة ربطات العنق الجامعية المخصصة. خيارات مطرزة أو مطبوعة بشعار الجامعة للكليات وجمعيات الخريجين." locale="ar" pageType="product" mainEntity="ربطات العنق الجامعية" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="ربطات العنق الجامعية" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'ربطات العنق الجامعية', url: '/ar/shop/education/university-attire/tie-collection' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'ربطات العنق الجامعية', href: '/ar/shop/education/university-attire/tie-collection' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">ربطات العنق الجامعية</h1>
            <p className="text-xl text-gray-300 leading-relaxed">تشكيلة ربطات العنق الجامعية المخصصة. خيارات مطرزة أو مطبوعة بشعار الجامعة للكليات وجمعيات الخريجين.</p>
          </div>
        </Container>
      </section>
