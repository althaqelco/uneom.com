...
export const metadata: Metadata = generateMetadata2026({
  title: 'معدات التدريب والزي الرياضي في السعودية | يونيوم',
  titleAr: 'معدات التدريب والزي الرياضي | متجر يونيوم',
  description: 'معدات تدريب وملابس رياضية للمدارس والجامعات. أقمشة تمتص العرق وأطقم كاملة يمكن تخصيصها.',
  descriptionAr: 'معدات تدريب وملابس رياضية للمدارس والجامعات. أقمشة تمتص العرق وأطقم كاملة يمكن تخصيصها.',
  keywords: ['زي رياضي مدرسي', 'ملابس رياضة جامعية', 'معدات تدريب'],
  keywordsAr: ['زي رياضي مدرسي', 'ملابس رياضة جامعية', 'معدات تدريب'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/education/sports-equipment/training-gear',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'معدات التدريب والزي الرياضي',
  aiSummary: 'معدات تدريب وملابس رياضية للمدارس والجامعات. أقمشة تمتص العرق وأطقم كاملة يمكن تخصيصها.',
});
...
export default function TrainingGearShopPageAR() {
  return (
    <>
      <SEO2026 title="معدات التدريب والزي الرياضي" titleAr="معدات التدريب والزي الرياضي" description="معدات تدريب وملابس رياضية للمدارس والجامعات. أقمشة تمتص العرق وأطقم كاملة يمكن تخصيصها." locale="ar" pageType="product" mainEntity="معدات التدريب والزي الرياضي" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="معدات التدريب والزي الرياضي" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'معدات التدريب والزي الرياضي', url: '/ar/shop/education/sports-equipment/training-gear' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'معدات التدريب والزي الرياضي', href: '/ar/shop/education/sports-equipment/training-gear' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">معدات التدريب والزي الرياضي</h1>
            <p className="text-xl text-gray-300 leading-relaxed">معدات تدريب وملابس رياضية للمدارس والجامعات. أقمشة تمتص العرق وأطقم كاملة يمكن تخصيصها.</p>
          </div>
        </Container>
      </section>
