...
export const metadata: Metadata = generateMetadata2026({
  title: 'أزياء قطاع التعليم في السعودية | يونيوم',
  titleAr: 'أزياء قطاع التعليم | متجر يونيوم',
  description: 'متجر أزياء قطاع التعليم في السعودية. زي مدرسي، أزياء جامعية، وملابس رياضية متوافقة مع معايير الجودة.',
  descriptionAr: 'متجر أزياء قطاع التعليم في السعودية. زي مدرسي، أزياء جامعية، وملابس رياضية متوافقة مع معايير الجودة.',
  keywords: ['زي مدرسي', 'أزياء جامعية', 'ملابس تعليم'],
  keywordsAr: ['زي مدرسي', 'أزياء جامعية', 'ملابس تعليم'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/education',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'أزياء قطاع التعليم',
  aiSummary: 'متجر أزياء قطاع التعليم في السعودية. زي مدرسي، أزياء جامعية، وملابس رياضية متوافقة مع معايير الجودة.',
});
...
export default function EducationShopPageAR() {
  return (
    <>
      <SEO2026 title="أزياء قطاع التعليم" titleAr="أزياء قطاع التعليم" description="متجر أزياء قطاع التعليم في السعودية. زي مدرسي، أزياء جامعية، وملابس رياضية متوافقة مع معايير الجودة." locale="ar" pageType="product" mainEntity="أزياء قطاع التعليم" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="أزياء قطاع التعليم" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'أزياء قطاع التعليم', url: '/ar/shop/education' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'أزياء قطاع التعليم', href: '/ar/shop/education' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">أزياء قطاع التعليم</h1>
            <p className="text-xl text-gray-300 leading-relaxed">متجر أزياء قطاع التعليم في السعودية. زي مدرسي، أزياء جامعية، وملابس رياضية متوافقة مع معايير الجودة.</p>
          </div>
        </Container>
      </section>
