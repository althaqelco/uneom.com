...
export const metadata: Metadata = generateMetadata2026({
  title: 'إكسسوارات الأمن في السعودية | يونيوم',
  titleAr: 'إكسسوارات الأمن | متجر يونيوم',
  description: 'إكسسوارات أمنية وتكتيكية تشمل أحزمة عسكرية، أشرطة عاكسة، وشارات أمنية مطرزة عالية المتانة.',
  descriptionAr: 'إكسسوارات أمنية وتكتيكية تشمل أحزمة عسكرية، أشرطة عاكسة، وشارات أمنية مطرزة عالية المتانة.',
  keywords: ['إكسسوارات أمن', 'أحزمة تكتيكية', 'تجهيزات حارس أمن'],
  keywordsAr: ['إكسسوارات أمن', 'أحزمة تكتيكية', 'تجهيزات حارس أمن'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/security-accessories',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'إكسسوارات الأمن',
  aiSummary: 'إكسسوارات أمنية وتكتيكية تشمل أحزمة عسكرية، أشرطة عاكسة، وشارات أمنية مطرزة عالية المتانة.',
});
...
export default function SecurityAccessoriesShopPageAR() {
  return (
    <>
      <SEO2026 title="إكسسوارات الأمن" titleAr="إكسسوارات الأمن" description="إكسسوارات أمنية وتكتيكية تشمل أحزمة عسكرية، أشرطة عاكسة، وشارات أمنية مطرزة عالية المتانة." locale="ar" pageType="product" mainEntity="إكسسوارات الأمن" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="إكسسوارات الأمن" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'إكسسوارات الأمن', url: '/ar/shop/security-accessories' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'إكسسوارات الأمن', href: '/ar/shop/security-accessories' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">إكسسوارات الأمن</h1>
            <p className="text-xl text-gray-300 leading-relaxed">إكسسوارات أمنية وتكتيكية تشمل أحزمة عسكرية، أشرطة عاكسة، وشارات أمنية مطرزة عالية المتانة.</p>
          </div>
        </Container>
      </section>
