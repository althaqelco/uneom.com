...
export default function HousekeepingUniformPageArabic() {
  ...
  const product = {
    ...
    images: [
      { src: '/images/hotel-housekeeping-staff-uniform-SBI-300674512.jpg', alt: 'طاقم النظافة المحترف بزي متين يحافظ على غرفة فندق فاخرة' },
      { src: '/images/female-housekeeper-uniform-hotel-SBI-300198674.jpg', alt: 'عاملة نظافة بزي محتشم مع ميزات تصميم مريحة في فندق فاخر سعودي' },
      { src: '/images/hotel-cleaning-team-professional-SBI-300912438.jpg', alt: 'فريق التدبير المنزلي بالفندق في أزياء مهنية منسقة للحفاظ على معايير الممتلكات' },
      { src: '/images/saudi-hotel-housekeeping-staff-SBI-301345789.jpg', alt: 'فريق النظافة السعودي في أزياء مهنية مناسبة ثقافيًا في منشأة من فئة خمس نجوم' }
    ],
    ...
    colors: [
      { name: 'أخضر تيل', value: '#008080', image: '/images/fabrics/teal-green-uniform.jpg' },
      { name: 'أزرق بحري', value: '#000080', image: '/images/fabrics/navy-blue-uniform.jpg' },
      { name: 'رمادي فحمي', value: '#36454F', image: '/images/fabrics/charcoal-grey-uniform.jpg' },
      { name: 'نبيذي', value: '#800020', image: '/images/fabrics/burgundy-uniform.jpg' },
      { name: 'كاكي', value: '#C3B091', image: '/images/fabrics/khaki-uniform.jpg' }
    ],
