...
export default function HospitalityAttireClientPage() {
  const locale = 'ar';
  ...
  return (
    <div className="bg-gray-50 min-h-screen" dir="rtl">
        ...
        <Container>
          <div className="py-16">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">أزياء الضيافة وملابس الفنادق والمطاعم | يونيوم المملكة العربية السعودية</h1>
              <p className="mt-4 text-lg text-gray-600">
                أزياء ضيافة أنيقة واحترافية مصممة للفنادق والمطاعم ومؤسسات الضيافة في المملكة العربية السعودية.
                تقدم مجموعتنا للضيافة جودة ممتازة وأناقة ومتانة لتعزيز صورة علامتك التجارية مع خيارات تخصيص متنوعة.
              </p>
            </div>
      ...
      <section className="py-16">
        <Container>
          <SectionHeading centered>لماذا تختار أزياء الضيافة من يونيوم؟</SectionHeading>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                أقمشة فاخرة وإنتاج دقيق يضمن أزياء ضيافة تدوم طويلاً حتى مع الاستخدام اليومي المكثف.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                خيارات تخصيص كاملة لتضمين شعار مؤسستك والألوان المؤسسية والاسم المطرز لتعزيز صورة علامتك التجارية.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold mb-2">راحة مطلقة</h3>
              <p className="text-gray-600 text-sm">
                تصميمات مدروسة للراحة طوال اليوم، مع أقمشة تسمح بالتنفس وقصات مريحة تناسب بيئة العمل في مجال الضيافة.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                من التصميم إلى التسليم، نقدم حلولاً شاملة لأزياء الضيافة تلبي احتياجات مؤسستك بالكامل.
              </p>
            </div>
          </div>
        </Container>
