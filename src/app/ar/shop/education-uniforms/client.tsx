...
export default function EducationUniformsClientPage() {
  const locale = 'ar';
  ...
  return (
    <div className="bg-gray-50 min-h-screen" dir="rtl">
        ...
        <Container>
          <div className="py-16">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">أزياء ومستلزمات المدارس والجامعات | زي موحد تعليمي عالي الجودة | يونيوم المملكة العربية السعودية</h1>
              <p className="mt-4 text-lg text-gray-600">
                أزياء تعليمية احترافية ومتينة مصممة للمدارس والجامعات والمؤسسات التعليمية في المملكة العربية السعودية.
                تقدم مجموعتنا التعليمية جودة وراحة ومظهرًا احترافيًا للطلاب والموظفين وأعضاء هيئة التدريس مع خيارات تخصيص واسعة.
              </p>
            </div>
      ...
      <section className="py-16">
        <Container>
          <SectionHeading centered>لماذا تختار الأزياء التعليمية من يونيوم؟</SectionHeading>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                أقمشة ممتازة وتفاصيل إنتاج عالية الجودة تضمن أزياء تدوم لفترة طويلة حتى مع الاستخدام اليومي في البيئات التعليمية.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 text-sm">
                خيارات تخصيص كاملة لتضمين شعار مؤسستك، الألوان المؤسسية، وتطريز الأسماء لتحسين هوية العلامة التجارية.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold mb-2">راحة متكاملة</h3>
              <p className="text-gray-600 text-sm">
                تصميمات مدروسة للراحة طوال اليوم، مع أقمشة قابلة للتنفس وقصات مريحة مثالية للبيئات التعليمية.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold mb-2">حلول شاملة</h3>
              <p className="text-gray-600 text-sm">
                من التصميم إلى التسليم، نقدم حلولاً شاملة للأزياء التعليمية تلبي احتياجات مؤسستك بأكملها.
              </p>
            </div>
          </div>
        </Container>
