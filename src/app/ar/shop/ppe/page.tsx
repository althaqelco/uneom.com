...
export const metadata: Metadata = generateMetadata2026({
  title: 'معدات الوقاية الشخصية (PPE) في السعودية | يونيوم',
  titleAr: 'معدات الوقاية الشخصية (PPE) | متجر يونيوم',
  description: 'متجر معدات الوقاية الشخصية المعتمدة في السعودية. سترات حماية، أحذية سلامة، وخوذ متوافقة مع معايير ساسو.',
  descriptionAr: 'متجر معدات الوقاية الشخصية المعتمدة في السعودية. سترات حماية، أحذية سلامة، وخوذ متوافقة مع معايير ساسو.',
  keywords: ['معدات وقاية شخصية', 'PPE السعودية', 'أحذية سيفتي'],
  keywordsAr: ['معدات وقاية شخصية', 'PPE السعودية', 'أحذية سيفتي'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/ppe',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'معدات الوقاية الشخصية (PPE)',
  aiSummary: 'متجر معدات الوقاية الشخصية المعتمدة في السعودية. سترات حماية، أحذية سلامة، وخوذ متوافقة مع معايير ساسو.',
});
...
export default function PPEShopPageAR() {
  return (
    <>
      <SEO2026 title="معدات الوقاية الشخصية (PPE)" titleAr="معدات الوقاية الشخصية (PPE)" description="متجر معدات الوقاية الشخصية المعتمدة في السعودية. سترات حماية، أحذية سلامة، وخوذ متوافقة مع معايير ساسو." locale="ar" pageType="product" mainEntity="معدات الوقاية الشخصية (PPE)" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="معدات الوقاية الشخصية (PPE)" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'معدات الوقاية الشخصية (PPE)', url: '/ar/shop/ppe' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'معدات الوقاية الشخصية (PPE)', href: '/ar/shop/ppe' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">معدات الوقاية الشخصية (PPE)</h1>
            <p className="text-xl text-gray-300 leading-relaxed">متجر معدات الوقاية الشخصية المعتمدة في السعودية. سترات حماية، أحذية سلامة، وخوذ متوافقة مع معايير ساسو.</p>
          </div>
        </Container>
      </section>
