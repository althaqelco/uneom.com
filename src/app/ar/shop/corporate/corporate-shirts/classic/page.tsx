...
export const metadata: Metadata = generateMetadata2026({
  title: 'القمصان المؤسسية الكلاسيكية في السعودية | يونيوم',
  titleAr: 'القمصان المؤسسية الكلاسيكية | متجر يونيوم',
  description: 'قمصان كلاسيكية رسمية لموظفي الشركات. قطن أكسفورد مقاوم للتجعد بألوان متنوعة.',
  descriptionAr: 'قمصان كلاسيكية رسمية لموظفي الشركات. قطن أكسفورد مقاوم للتجعد بألوان متنوعة.',
  keywords: ['قمصان شركات', 'قمصان رسمية موحدة', 'قمصان موظفين'],
  keywordsAr: ['قمصان شركات', 'قمصان رسمية موحدة', 'قمصان موظفين'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/corporate/corporate-shirts/classic',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'القمصان المؤسسية الكلاسيكية',
  aiSummary: 'قمصان كلاسيكية رسمية لموظفي الشركات. قطن أكسفورد مقاوم للتجعد بألوان متنوعة.',
});
...
export default function ClassicCorporateShirtsShopPageAR() {
  return (
    <>
      <SEO2026 title="القمصان المؤسسية الكلاسيكية" titleAr="القمصان المؤسسية الكلاسيكية" description="قمصان كلاسيكية رسمية لموظفي الشركات. قطن أكسفورد مقاوم للتجعد بألوان متنوعة." locale="ar" pageType="product" mainEntity="القمصان المؤسسية الكلاسيكية" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="القمصان المؤسسية الكلاسيكية" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'القمصان المؤسسية الكلاسيكية', url: '/ar/shop/corporate/corporate-shirts/classic' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'القمصان المؤسسية الكلاسيكية', href: '/ar/shop/corporate/corporate-shirts/classic' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">القمصان المؤسسية الكلاسيكية</h1>
            <p className="text-xl text-gray-300 leading-relaxed">قمصان كلاسيكية رسمية لموظفي الشركات. قطن أكسفورد مقاوم للتجعد بألوان متنوعة.</p>
          </div>
        </Container>
      </section>
