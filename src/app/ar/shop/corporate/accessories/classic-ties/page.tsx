...
export const metadata: Metadata = generateMetadata2026({
  title: 'ربطات العنق الكلاسيكية في السعودية | يونيوم',
  titleAr: 'ربطات العنق الكلاسيكية | متجر يونيوم',
  description: 'مجموعة فاخرة من ربطات العنق الكلاسيكية المصنوعة من الحرير والميكروفايبر. يمكن تخصيصها بشعار الشركة.',
  descriptionAr: 'مجموعة فاخرة من ربطات العنق الكلاسيكية المصنوعة من الحرير والميكروفايبر. يمكن تخصيصها بشعار الشركة.',
  keywords: ['ربطات عنق كلاسيكية', 'ربطة عنق بشعار', 'كرافتات شركات'],
  keywordsAr: ['ربطات عنق كلاسيكية', 'ربطة عنق بشعار', 'كرافتات شركات'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/corporate/accessories/classic-ties',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'ربطات العنق الكلاسيكية',
  aiSummary: 'مجموعة فاخرة من ربطات العنق الكلاسيكية المصنوعة من الحرير والميكروفايبر. يمكن تخصيصها بشعار الشركة.',
});
...
export default function ClassicTiesShopPageAR() {
  return (
    <>
      <SEO2026 title="ربطات العنق الكلاسيكية" titleAr="ربطات العنق الكلاسيكية" description="مجموعة فاخرة من ربطات العنق الكلاسيكية المصنوعة من الحرير والميكروفايبر. يمكن تخصيصها بشعار الشركة." locale="ar" pageType="product" mainEntity="ربطات العنق الكلاسيكية" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="ربطات العنق الكلاسيكية" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'ربطات العنق الكلاسيكية', url: '/ar/shop/corporate/accessories/classic-ties' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'ربطات العنق الكلاسيكية', href: '/ar/shop/corporate/accessories/classic-ties' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">ربطات العنق الكلاسيكية</h1>
            <p className="text-xl text-gray-300 leading-relaxed">مجموعة فاخرة من ربطات العنق الكلاسيكية المصنوعة من الحرير والميكروفايبر. يمكن تخصيصها بشعار الشركة.</p>
          </div>
        </Container>
      </section>
