...
export const metadata: Metadata = generateMetadata2026({
  title: 'قمصان الإدارة العليا الفاخرة في السعودية | يونيوم',
  titleAr: 'قمصان الإدارة العليا الفاخرة | متجر يونيوم',
  description: 'قمصان فاخرة مخصصة للإدارة العليا والتنفيذيين. أقمشة إيطالية فائقة الجودة وتفصيل حسب الطلب.',
  descriptionAr: 'قمصان فاخرة مخصصة للإدارة العليا والتنفيذيين. أقمشة إيطالية فائقة الجودة وتفصيل حسب الطلب.',
  keywords: ['قمصان فاخرة', 'قمصان إدارة عليا', 'تفصيل قمصان رسمية'],
  keywordsAr: ['قمصان فاخرة', 'قمصان إدارة عليا', 'تفصيل قمصان رسمية'],
  locale: 'ar',
  pageType: 'product',
  path: '/ar/shop/corporate/executive-shirts/premium',
  image: '/images/hero/hero-1.jpg',
  imageAlt: 'قمصان الإدارة العليا الفاخرة',
  aiSummary: 'قمصان فاخرة مخصصة للإدارة العليا والتنفيذيين. أقمشة إيطالية فائقة الجودة وتفصيل حسب الطلب.',
});
...
export default function PremiumExecutiveShirtsShopPageAR() {
  return (
    <>
      <SEO2026 title="قمصان الإدارة العليا الفاخرة" titleAr="قمصان الإدارة العليا الفاخرة" description="قمصان فاخرة مخصصة للإدارة العليا والتنفيذيين. أقمشة إيطالية فائقة الجودة وتفصيل حسب الطلب." locale="ar" pageType="product" mainEntity="قمصان الإدارة العليا الفاخرة" primaryImage="/images/hero/hero-1.jpg" primaryImageAlt="قمصان الإدارة العليا الفاخرة" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'قمصان الإدارة العليا الفاخرة', url: '/ar/shop/corporate/executive-shirts/premium' }]} certifications={['SASO']} clientCount={200} yearsInBusiness={20} industry="تجهيزات مهنية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-indigo-900 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'قمصان الإدارة العليا الفاخرة', href: '/ar/shop/corporate/executive-shirts/premium' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">قمصان الإدارة العليا الفاخرة</h1>
            <p className="text-xl text-gray-300 leading-relaxed">قمصان فاخرة مخصصة للإدارة العليا والتنفيذيين. أقمشة إيطالية فائقة الجودة وتفصيل حسب الطلب.</p>
          </div>
        </Container>
      </section>
