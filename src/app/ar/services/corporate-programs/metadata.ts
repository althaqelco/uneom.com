...
export const metadata: Metadata = {
  ...
  keywords: [
    'برامج الأزياء الموحدة للشركات',
    'إدارة الزي الموحد',
    'الأزياء الموحدة للشركات السعودية',
    'توريد الزي الموحد للشركات',
    'إدارة مخزون الزي الموحد',
    'حلول الزي الموحد للمؤسسات',
    'تصميم الزي الموحد للشركات',
    'برامج الملابس المهنية',
    'أزياء موحدة مخصصة للشركات',
    'يونيوم السعودية'
  ],
  alternates: {
