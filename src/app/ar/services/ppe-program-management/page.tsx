...
export const metadata: Metadata = generateMetadata2026({
  title: 'إدارة برنامج معدات الوقاية الشخصية السعودية | يونيوم',
  titleAr: 'إدارة برنامج معدات الوقاية الشخصية | حلول متكاملة - يونيوم',
  description: 'إدارة شاملة لمعدات الوقاية الشخصية (PPE) للشركات السعودية. امتثال كامل لمعايير أرامكو وساسو والأيزو.',
  descriptionAr: 'إدارة شاملة لمعدات الوقاية الشخصية (PPE) للشركات السعودية. امتثال كامل لمعايير أرامكو وساسو والأيزو.',
  keywords: ['إدارة معدات الوقاية', 'معدات سلامة السعودية', 'PPE أرامكو'],
  keywordsAr: ['إدارة معدات الوقاية', 'معدات سلامة السعودية', 'PPE أرامكو'],
  locale: 'ar',
  pageType: 'service',
  path: '/ar/services/ppe-program-management',
  image: '/images/services/ppe-program.jpg',
  imageAlt: 'إدارة برنامج معدات الوقاية الشخصية',
  aiSummary: 'إدارة شاملة لمعدات الوقاية الشخصية (PPE) للشركات السعودية. امتثال كامل لمعايير أرامكو وساسو والأيزو.',
});
...
export default function PPEProgramManagementPageAR() {
  return (
    <>
      <SEO2026 title="إدارة برنامج معدات الوقاية الشخصية" titleAr="إدارة برنامج معدات الوقاية الشخصية" description="إدارة شاملة لمعدات الوقاية الشخصية (PPE) للشركات السعودية. امتثال كامل لمعايير أرامكو وساسو والأيزو." locale="ar" pageType="service" mainEntity="إدارة برنامج معدات الوقاية الشخصية" primaryImage="/images/services/ppe-program.jpg" primaryImageAlt="إدارة برنامج معدات الوقاية الشخصية" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'الخدمات', url: '/ar/services' }, { name: 'إدارة برنامج معدات الوقاية الشخصية', url: '/ar/services/ppe-program-management' }]} certifications={['SASO', 'ISO 9001']} clientCount={300} yearsInBusiness={20} industry="الخدمات المؤسسية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-slate-800 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'الخدمات', href: '/ar/services' }, { label: 'إدارة برنامج معدات الوقاية الشخصية', href: '/ar/services/ppe-program-management' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">إدارة برنامج معدات الوقاية الشخصية</h1>
            <p className="text-xl text-gray-300 leading-relaxed">إدارة شاملة لمعدات الوقاية الشخصية (PPE) للشركات السعودية. امتثال كامل لمعايير أرامكو وساسو والأيزو.</p>
          </div>
        </Container>
      </section>
