...
export const metadata: Metadata = {
  title: 'Lightweight Tactical Program | Services - يونيوم للزي الموحد',
  description: 'اكتشف أفضل Lightweight Tactical Program من يونيوم. نقدم حلول الزي الموحد عالية الجودة في السعودية مع توصيل سريع.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              اكتشف أفضل Lightweight Tactical Program من يونيوم. نقدم حلول الزي الموحد عالية الجودة في السعودية مع توصيل سريع.
            </p>
      ...
      <main className="py-16 bg-gray-50">
        <Container>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 text-center max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">حلول متقدمة لقطاع Services</h2>
