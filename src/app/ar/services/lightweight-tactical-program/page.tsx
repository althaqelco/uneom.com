...
export const metadata: Metadata = generateMetadata2026({
  title: 'برنامج الأزياء التكتيكية الخفيفة السعودية | يونيوم',
  titleAr: 'برنامج الأزياء التكتيكية الخفيفة | حلول متكاملة - يونيوم',
  description: 'أزياء تكتيكية خفيفة الوزن مصممة خصيصاً للمناخ السعودي القاسي. مثالية لعمليات الحراسة وحماية الشخصيات.',
  descriptionAr: 'أزياء تكتيكية خفيفة الوزن مصممة خصيصاً للمناخ السعودي القاسي. مثالية لعمليات الحراسة وحماية الشخصيات.',
  keywords: ['أزياء تكتيكية خفيفة', 'ملابس أمنية سعودية', 'حماية شخصيات'],
  keywordsAr: ['أزياء تكتيكية خفيفة', 'ملابس أمنية سعودية', 'حماية شخصيات'],
  locale: 'ar',
  pageType: 'service',
  path: '/ar/services/lightweight-tactical-program',
  image: '/images/services/lightweight-tactical.jpg',
  imageAlt: 'برنامج الأزياء التكتيكية الخفيفة',
  aiSummary: 'أزياء تكتيكية خفيفة الوزن مصممة خصيصاً للمناخ السعودي القاسي. مثالية لعمليات الحراسة وحماية الشخصيات.',
});
...
export default function LightweightTacticalProgramPageAR() {
  return (
    <>
      <SEO2026 title="برنامج الأزياء التكتيكية الخفيفة" titleAr="برنامج الأزياء التكتيكية الخفيفة" description="أزياء تكتيكية خفيفة الوزن مصممة خصيصاً للمناخ السعودي القاسي. مثالية لعمليات الحراسة وحماية الشخصيات." locale="ar" pageType="service" mainEntity="برنامج الأزياء التكتيكية الخفيفة" primaryImage="/images/services/lightweight-tactical.jpg" primaryImageAlt="برنامج الأزياء التكتيكية الخفيفة" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'الخدمات', url: '/ar/services' }, { name: 'برنامج الأزياء التكتيكية الخفيفة', url: '/ar/services/lightweight-tactical-program' }]} certifications={['SASO', 'ISO 9001']} clientCount={300} yearsInBusiness={20} industry="الخدمات المؤسسية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-slate-800 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'الخدمات', href: '/ar/services' }, { label: 'برنامج الأزياء التكتيكية الخفيفة', href: '/ar/services/lightweight-tactical-program' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">برنامج الأزياء التكتيكية الخفيفة</h1>
            <p className="text-xl text-gray-300 leading-relaxed">أزياء تكتيكية خفيفة الوزن مصممة خصيصاً للمناخ السعودي القاسي. مثالية لعمليات الحراسة وحماية الشخصيات.</p>
          </div>
        </Container>
      </section>
