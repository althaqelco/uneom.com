...
export const metadata: Metadata = generateMetadata2026({
  title: 'برنامج الدوريات التكتيكية السعودية | يونيوم',
  titleAr: 'برنامج الدوريات التكتيكية | حلول متكاملة - يونيوم',
  description: 'أزياء دوريات أمنية مصممة للحركة والمرونة العالية في المناخ السعودي. تحمل أقصى ظروف العمل.',
  descriptionAr: 'أزياء دوريات أمنية مصممة للحركة والمرونة العالية في المناخ السعودي. تحمل أقصى ظروف العمل.',
  keywords: ['أزياء دوريات', 'ملابس دوريات تكتيكية', 'أمن سعودي'],
  keywordsAr: ['أزياء دوريات', 'ملابس دوريات تكتيكية', 'أمن سعودي'],
  locale: 'ar',
  pageType: 'service',
  path: '/ar/services/tactical-patrol-program',
  image: '/images/services/tactical-patrol.jpg',
  imageAlt: 'برنامج الدوريات التكتيكية',
  aiSummary: 'أزياء دوريات أمنية مصممة للحركة والمرونة العالية في المناخ السعودي. تحمل أقصى ظروف العمل.',
});
...
export default function TacticalPatrolProgramPageAR() {
  return (
    <>
      <SEO2026 title="برنامج الدوريات التكتيكية" titleAr="برنامج الدوريات التكتيكية" description="أزياء دوريات أمنية مصممة للحركة والمرونة العالية في المناخ السعودي. تحمل أقصى ظروف العمل." locale="ar" pageType="service" mainEntity="برنامج الدوريات التكتيكية" primaryImage="/images/services/tactical-patrol.jpg" primaryImageAlt="برنامج الدوريات التكتيكية" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'الخدمات', url: '/ar/services' }, { name: 'برنامج الدوريات التكتيكية', url: '/ar/services/tactical-patrol-program' }]} certifications={['SASO', 'ISO 9001']} clientCount={300} yearsInBusiness={20} industry="الخدمات المؤسسية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-slate-800 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'الخدمات', href: '/ar/services' }, { label: 'برنامج الدوريات التكتيكية', href: '/ar/services/tactical-patrol-program' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">برنامج الدوريات التكتيكية</h1>
            <p className="text-xl text-gray-300 leading-relaxed">أزياء دوريات أمنية مصممة للحركة والمرونة العالية في المناخ السعودي. تحمل أقصى ظروف العمل.</p>
          </div>
        </Container>
      </section>
