...
export const metadata: Metadata = generateMetadata2026({
  title: 'برنامج الأمن الاحترافي السعودية | يونيوم',
  titleAr: 'برنامج الأمن الاحترافي | حلول متكاملة - يونيوم',
  description: 'أزياء وحلول أمنية احترافية لشركات الحراسات في السعودية. تصاميم تعكس القوة والموثوقية.',
  descriptionAr: 'أزياء وحلول أمنية احترافية لشركات الحراسات في السعودية. تصاميم تعكس القوة والموثوقية.',
  keywords: ['أزياء أمن احترافي', 'شركات حراسة سعودية', 'زي حراس أمن'],
  keywordsAr: ['أزياء أمن احترافي', 'شركات حراسة سعودية', 'زي حراس أمن'],
  locale: 'ar',
  pageType: 'service',
  path: '/ar/services/professional-security-program',
  image: '/images/services/professional-security.jpg',
  imageAlt: 'برنامج الأمن الاحترافي',
  aiSummary: 'أزياء وحلول أمنية احترافية لشركات الحراسات في السعودية. تصاميم تعكس القوة والموثوقية.',
});
...
export default function ProfessionalSecurityProgramPageAR() {
  return (
    <>
      <SEO2026 title="برنامج الأمن الاحترافي" titleAr="برنامج الأمن الاحترافي" description="أزياء وحلول أمنية احترافية لشركات الحراسات في السعودية. تصاميم تعكس القوة والموثوقية." locale="ar" pageType="service" mainEntity="برنامج الأمن الاحترافي" primaryImage="/images/services/professional-security.jpg" primaryImageAlt="برنامج الأمن الاحترافي" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'الخدمات', url: '/ar/services' }, { name: 'برنامج الأمن الاحترافي', url: '/ar/services/professional-security-program' }]} certifications={['SASO', 'ISO 9001']} clientCount={300} yearsInBusiness={20} industry="الخدمات المؤسسية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-slate-800 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'الخدمات', href: '/ar/services' }, { label: 'برنامج الأمن الاحترافي', href: '/ar/services/professional-security-program' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">برنامج الأمن الاحترافي</h1>
            <p className="text-xl text-gray-300 leading-relaxed">أزياء وحلول أمنية احترافية لشركات الحراسات في السعودية. تصاميم تعكس القوة والموثوقية.</p>
          </div>
        </Container>
      </section>
