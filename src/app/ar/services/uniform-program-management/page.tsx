...
export const metadata: Metadata = generateMetadata2026({
  title: 'إدارة برامج الزي الموحد السعودية | يونيوم',
  titleAr: 'إدارة برامج الزي الموحد | حلول متكاملة - يونيوم',
  description: 'خدمة إدارة متكاملة لبرامج الزي الموحد للشركات. من التصميم إلى التوزيع وإدارة المخزون في جميع أنحاء المملكة.',
  descriptionAr: 'خدمة إدارة متكاملة لبرامج الزي الموحد للشركات. من التصميم إلى التوزيع وإدارة المخزون في جميع أنحاء المملكة.',
  keywords: ['إدارة الزي الموحد', 'حلول ملابس الشركات', 'لوجستيات الأزياء'],
  keywordsAr: ['إدارة الزي الموحد', 'حلول ملابس الشركات', 'لوجستيات الأزياء'],
  locale: 'ar',
  pageType: 'service',
  path: '/ar/services/uniform-program-management',
  image: '/images/services/program-management.jpg',
  imageAlt: 'إدارة برامج الزي الموحد',
  aiSummary: 'خدمة إدارة متكاملة لبرامج الزي الموحد للشركات. من التصميم إلى التوزيع وإدارة المخزون في جميع أنحاء المملكة.',
});
...
export default function UniformProgramManagementPageAR() {
  return (
    <>
      <SEO2026 title="إدارة برامج الزي الموحد" titleAr="إدارة برامج الزي الموحد" description="خدمة إدارة متكاملة لبرامج الزي الموحد للشركات. من التصميم إلى التوزيع وإدارة المخزون في جميع أنحاء المملكة." locale="ar" pageType="service" mainEntity="إدارة برامج الزي الموحد" primaryImage="/images/services/program-management.jpg" primaryImageAlt="إدارة برامج الزي الموحد" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'الخدمات', url: '/ar/services' }, { name: 'إدارة برامج الزي الموحد', url: '/ar/services/uniform-program-management' }]} certifications={['SASO', 'ISO 9001']} clientCount={300} yearsInBusiness={20} industry="الخدمات المؤسسية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-slate-800 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'الخدمات', href: '/ar/services' }, { label: 'إدارة برامج الزي الموحد', href: '/ar/services/uniform-program-management' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">إدارة برامج الزي الموحد</h1>
            <p className="text-xl text-gray-300 leading-relaxed">خدمة إدارة متكاملة لبرامج الزي الموحد للشركات. من التصميم إلى التوزيع وإدارة المخزون في جميع أنحاء المملكة.</p>
          </div>
        </Container>
      </section>
