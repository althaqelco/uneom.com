      ...
      <section className="container-page pb-24">
        <div className="grid gap-px overflow-hidden rounded-3xl bg-ink-100 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, i) => (
            <Link key={service.slug} href={`/ar/services/${service.slug}/`} className="group flex flex-col overflow-hidden bg-white transition-colors hover:bg-ink-50/60">
              <div className="relative aspect-[16/9] overflow-hidden bg-ink-100">
                <picture>
                  ...
                  <img src={`/images/${service.heroImage}.avif`} alt={service.nameAr} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" loading="lazy" width={640} height={360} />
                </picture>
              </div>
