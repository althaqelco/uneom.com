...
export const metadata: Metadata = generateMetadata2026({
  title: 'برنامج أزياء الأمن السعودية | يونيوم',
  titleAr: 'برنامج أزياء الأمن | حلول متكاملة - يونيوم',
  description: 'حلول متكاملة لأزياء الأمن والحراسات. أقمشة متينة، ومعدات متطورة لتلبية متطلبات القطاع الأمني في المملكة.',
  descriptionAr: 'حلول متكاملة لأزياء الأمن والحراسات. أقمشة متينة، ومعدات متطورة لتلبية متطلبات القطاع الأمني في المملكة.',
  keywords: ['أزياء الأمن', 'ملابس حراس أمن', 'تجهيزات أمنية سعودية'],
  keywordsAr: ['أزياء الأمن', 'ملابس حراس أمن', 'تجهيزات أمنية سعودية'],
  locale: 'ar',
  pageType: 'service',
  path: '/ar/services/security-uniform-program',
  image: '/images/services/security-uniforms.jpg',
  imageAlt: 'برنامج أزياء الأمن',
  aiSummary: 'حلول متكاملة لأزياء الأمن والحراسات. أقمشة متينة، ومعدات متطورة لتلبية متطلبات القطاع الأمني في المملكة.',
});
...
export default function SecurityUniformProgramPageAR() {
  return (
    <>
      <SEO2026 title="برنامج أزياء الأمن" titleAr="برنامج أزياء الأمن" description="حلول متكاملة لأزياء الأمن والحراسات. أقمشة متينة، ومعدات متطورة لتلبية متطلبات القطاع الأمني في المملكة." locale="ar" pageType="service" mainEntity="برنامج أزياء الأمن" primaryImage="/images/services/security-uniforms.jpg" primaryImageAlt="برنامج أزياء الأمن" faqs={faqs} breadcrumbs={[{ name: 'الرئيسية', url: '/ar' }, { name: 'الخدمات', url: '/ar/services' }, { name: 'برنامج أزياء الأمن', url: '/ar/services/security-uniform-program' }]} certifications={['SASO', 'ISO 9001']} clientCount={300} yearsInBusiness={20} industry="الخدمات المؤسسية" />
      <section className="bg-gradient-to-bl from-slate-900 via-gray-800 to-slate-800 text-white" dir="rtl">
        <Container>
          <Breadcrumbs items={[{ label: 'الرئيسية', href: '/ar' }, { label: 'الخدمات', href: '/ar/services' }, { label: 'برنامج أزياء الأمن', href: '/ar/services/security-uniform-program' }]} className="text-white/80 mb-6 pt-8" />
          <div className="py-16 lg:py-24 max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">برنامج أزياء الأمن</h1>
            <p className="text-xl text-gray-300 leading-relaxed">حلول متكاملة لأزياء الأمن والحراسات. أقمشة متينة، ومعدات متطورة لتلبية متطلبات القطاع الأمني في المملكة.</p>
          </div>
        </Container>
      </section>
