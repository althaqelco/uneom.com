...
export const metadata: Metadata = {
  title: 'Nfpa70e Guide | Resources - يونيوم للزي الموحد',
  description: 'اكتشف أفضل Nfpa70e Guide من يونيوم. نقدم حلول الزي الموحد عالية الجودة في السعودية مع توصيل سريع.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              اكتشف أفضل Nfpa70e Guide من يونيوم. نقدم حلول الزي الموحد عالية الجودة في السعودية مع توصيل سريع.
            </p>
