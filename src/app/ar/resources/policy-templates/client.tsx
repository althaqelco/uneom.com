...
export default function PolicyTemplatesClientPageArabic() {
  const resourceData = {
    locale: 'ar',
          ...
          <div class="border border-primary-200 rounded-lg p-6 mb-6 bg-primary-50">
            ...
            <div class="bg-white p-4 rounded border border-gray-200 text-sm">
              <p class="font-medium italic text-neutral-700">
                "[اسم المؤسسة] تطلب من الموظفين ارتداء زي موحد لتقديم صورة مهنية ومتسقة 
        ...
        content: `
          ...
          <div class="mb-6 bg-neutral-50 p-5 rounded-lg">
            ...
            <ol class="list-decimal pr-5 mb-3 space-y-2">
              ...
              <li>
                <span class="font-medium">المراقبة والمراجعة:</span> 
                <p class="mr-1">مراجعة دورية لفعالية السياسة وإجراء التعديلات اللازمة.</p>
              </li>
            </ol>
          </div>
    ...
    relatedResources: [
      {
        title: 'دراسات الحالة',
        description: 'تعرف على كيفية تطبيق المؤسسات الأخرى لسياسات الزي الموحد بنجاح.',
        link: '/ar/resources/case-studies',
        icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'
      },
      {
        title: 'دليل مشتريات الزي الموحد',
        description: 'إرشادات لاختيار وشراء الزي الموحد الذي يتوافق مع سياساتك.',
        link: '/ar/resources/procurement-guide',
        icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z'
      },
      {
        title: 'استشارات الزي الموحد',
        description: 'احصل على مساعدة الخبراء في تطوير سياسة الزي الموحد الخاصة بك.',
        link: '/ar/services/consultations',
        icon: 'M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z'
      }
    ],
    cta: {
      title: 'هل تحتاج إلى مساعدة في إنشاء سياسة الزي الموحد الخاصة بك؟',
      description: 'يمكن لخبرائنا مساعدتك في صياغة سياسة شاملة وفعالة للزي الموحد مصممة خصيصًا لاحتياجات مؤسستك.',
      buttonText: 'تحدث إلى خبير',
      buttonUrl: '/ar/contact?inquiry=policy-templates'
    }
  };
