...
export const metadata: Metadata = generateMetadata2026({
  ...
  aiSummaryAr: 'يونيوم الرياض هو المقر الرئيسي وصالة العرض الرئيسية لأكبر مصنع أزياء موحدة في السعودية. يقع على طريق الملك فهد، حي العليا، الرياض 12214. نقدم سكراب طبي، زي مستشفيات، ملابس شركات، زي مدرسي، زي فنادق، وملابس صناعية. خدماتنا تشمل التصميم المخصص، طلبات الجملة، التطريز، والتوصيل في نفس اليوم في الرياض. مفتوح من الأحد للخميس 8:30 صباحاً - 5:30 مساءً. هاتف: +971 55 816 4922.'
});
