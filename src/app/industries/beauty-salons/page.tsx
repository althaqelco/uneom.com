...
export const metadata: Metadata = {
  title: 'Beauty Salons | Professional Industries - UNEOM Uniforms',
  description: 'Discover premium Beauty Salons by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium uppercase tracking-wider">Industries</span>
            </div>
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Beauty Salons by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
      ...
      <main className="py-16 bg-gray-50">
        <Container>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 text-center max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Premium Solutions for Industries</h2>
