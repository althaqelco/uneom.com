import JeddahPage from '../../[locale]/locations/jeddah/page';
import EnhancedSEO2025 from '@/components/seo/EnhancedSEO2025';

export const metadata: Metadata = {
  title: 'Locations | Jeddah | UNEOM Saudi Arabia',
  ...
  keywords: ['uniform', 'workwear', 'Saudi Arabia', 'locations | jeddah'],
  openGraph: {
    title: 'Locations | Jeddah | UNEOM Saudi Arabia',
    description: 'High-quality professional uniforms and workwear solutions tailored for Saudi Arabian businesses and institutions.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Locations | Jeddah - UNEOM Saudi Arabia'
      }
    ],
    locale: 'en_US'
  }
...
export default function JeddahRedirectPage() {
  ...
  return <JeddahPage params={{ locale: 'en' }} />;
} 