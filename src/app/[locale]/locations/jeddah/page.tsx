...
export const generateMetadata = ({ params }: { params: { locale: Locale } }): Metadata => {
  ...
  return {
    title: locale === 'ar' 
      ? `يونيوم جدة | حلول الزي الموحد المتخصصة للضيافة والطيران` 
      : `UNEOM Jeddah | Specialized Hospitality & Aviation Uniform Solutions`,
    description: locale === 'ar'
      ? `استكشف خدمات يونيوم للزي الموحد في جدة، المتخصصة في حلول الضيافة والطيران. نقدم تصاميم مبتكرة وأقمشة عالية الأداء مناسبة للمناخ الساحلي.`
      : `Explore UNEOM's uniform services in Jeddah, specializing in hospitality and aviation solutions. We provide innovative designs and high-performance fabrics suitable for the coastal climate.`,
    alternates: {
