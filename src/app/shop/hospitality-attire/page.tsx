...
const products = [
  ...
  { id: 'concierge-attire', name: 'Concierge Attire', description: 'Sophisticated uniforms for guest services', price: 'From SAR 349', image: '/images/hospitality/hospitality_uniform_concierge.jpg', href: '/shop/hospitality-attire/concierge-uniform', features: ['Premium fabric', 'Tailored fit', 'Professional'] },
  ...
  { id: 'spa-uniform', name: 'Spa & Wellness Uniform', description: 'Relaxed uniforms for spa therapists', price: 'From SAR 229', image: '/images/products/spa-uniform.jpg', href: '/shop/hospitality-attire/resort-staff-attire', features: ['Soft fabric', 'Relaxed fit', 'Professional'] },
];
