...
export default function AviationBlazerPage() {
  ...
  const content: ContentType = {
    ...
    ar: {
      ...
      longDescription: 'تمثل سترات الطيران لدينا قمة زي الطيران المهني، مصممة بدقة للطيارين وكبار طاقم المقصورة ومديري الخطوط الجوية في قطاع الطيران السعودي. تجمع كل سترة بين التصميم المتطور والميزات الوظيفية المصممة خصيصًا لمحترفي الطيران. يضمن بناء مزيج الصوف الفاخر مع عناصر التمدد الراحة أثناء الرحلات الطويلة مع الحفاظ على مظهر لا تشوبه شائبة يفرض الاحترام ويعكس السلطة. متوفرة مع ميزات قابلة للتخصيص تشمل أزرار خاصة بالخطوط الجوية وأجنحة مطرزة وأكتاف وتفاصيل علم المملكة العربية السعودية، تم تصميم هذه السترات لتعزيز هوية العلامة التجارية لشركة الطيران الخاصة بك مع تلبية معايير الطيران الدولية. تخضع كل قطعة لاختبارات جودة صارمة لضمان متانة استثنائية في بيئة الطيران الصعبة، مع معالجات متخصصة تحافظ على حيوية اللون وسلامة الهيكل من خلال الارتداء والسفر المتكرر.',
      breadcrumbs: [
      ...
      features: [
        ...
        'أزرار قابلة للتخصيص وشعارات الأجنحة وتفاصيل خاصة بالخطوط الجوية',
        'خيار علم السعودية وتطريز النص العربي متاح',
