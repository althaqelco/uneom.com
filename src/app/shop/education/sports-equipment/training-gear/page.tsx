...
export const metadata: Metadata = {
  title: 'Training Gear | Professional Shop - UNEOM Uniforms',
  description: 'Discover premium Training Gear by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.',
};
        ...
        <Container>
          <div className="relative z-10 max-w-4xl">
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed max-w-2xl">
              Discover premium Training Gear by UNEOM. We provide high-quality professional uniforms across Saudi Arabia with fast delivery.
            </p>
