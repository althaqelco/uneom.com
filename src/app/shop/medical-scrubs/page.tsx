...
const products = [
  ...
  { id: 'nursing-uniform-set', name: 'Nursing Uniform Set', nameAr: 'طقم زي تمريض', description: 'Comfortable nursing uniforms for long shifts', price: 'From SAR 149', image: '/images/healthcare/nurse-uniform.jpg', href: '/shop/medical-scrubs/nursing-uniform-set', features: ['Breathable', 'Stretch fabric', 'Multiple pockets'], rating: 4.8 },
  ...
  { id: 'doctor-coat', name: 'Doctor White Coat', nameAr: 'معطف طبيب أبيض', description: 'Classic white coats for physicians', price: 'From SAR 179', image: '/images/healthcare/healthcare_medical_doctor.jpg', href: '/shop/medical-scrubs/doctor-coat', features: ['Premium fabric', 'Wrinkle-free', 'Embroidery-ready'], rating: 4.8 },
