...
const categories = [
  ...
  { id: 'industrial-uniforms', name: 'Industrial Workwear', nameAr: 'الملابس الصناعية', description: 'Coveralls, safety wear, FR clothing', image: '/images/products/industrial-coverall.jpg', href: '/shop/industrial-uniforms', price: 'From SAR 199', popular: true, gradient: 'from-yellow-600 to-orange-600' },
