...
// ============================================
const categories = [
  { id: 'medical-scrubs', name: 'Healthcare Apparel', nameAr: 'الملابس الصحية', description: 'Medical scrubs, lab coats, nursing uniforms', image: '/images/products/scrubs-set.jpg', href: '/shop/medical-scrubs', price: 'From SAR 169', popular: true, gradient: 'from-emerald-600 to-teal-600' },
  { id: 'aviation-uniforms', name: 'Aviation Uniforms', nameAr: 'أزياء الطيران', description: 'Pilot, flight attendant, ground crew uniforms', image: '/images/airline-1.jpg', href: '/shop/aviation-uniforms', price: 'From SAR 899', popular: false, gradient: 'from-blue-600 to-sky-600' },
  { id: 'hospitality-attire', name: 'Hospitality Attire', nameAr: 'أزياء الضيافة', description: 'Hotel, restaurant, concierge uniforms', image: '/images/hospitality_uniform_concierge.jpg', href: '/shop/hospitality-attire', price: 'From SAR 329', popular: true, gradient: 'from-orange-600 to-amber-600' },
  ...
  { id: 'security-uniforms', name: 'Security Uniforms', nameAr: 'أزياء الأمن', description: 'Guard uniforms, tactical wear', image: '/images/products/security-officer-uniform.jpg', href: '/shop/security-uniforms', price: 'From SAR 299', popular: false, gradient: 'from-gray-800 to-gray-900' },
];
