            ...
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <Image src="/images/clients/modern-arabic-businessman-SBI-300984397.jpg" alt={`Testimonial from ${testimonial.name}`} width={48} height={48} className="rounded-full mr-4" />
                  <div>
