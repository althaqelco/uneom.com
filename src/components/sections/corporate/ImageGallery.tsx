        ...
        >
          {images.map((image, index) => (
            <motion.div 
              ...
              title={locale === 'ar' ? `عرض ${image.alt} بالحجم الكامل` : `View ${image.alt} in full size`}
            >
        ...
        >
          <div className="relative max-w-6xl w-full">
            <button 
              ...
              title={locale === 'ar' ? 'إغلاق عرض الصورة' : 'Close Image View'}
            >
            ...
            <button 
              ...
              title={locale === 'ar' ? 'عرض الصورة السابقة' : 'View Previous Corporate Uniform Image'}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              ...
              title={locale === 'ar' ? 'عرض الصورة التالية' : 'View Next Corporate Uniform Image'}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
